      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-base text-gray-500">
              Discover your next favorite book with honest reviews from real readers.
            </p>
            <div className="flex space-x-6">
              <a href="https://facebook.com/bookcritic" className="text-gray-400 hover:text-gray-500">
              ...
              <a href="https://instagram.com/bookcritic" className="text-gray-400 hover:text-gray-500">
              ...
              <a href="https://twitter.com/bookcritic" className="text-gray-400 hover:text-gray-500">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  ...
                  <li>
                    <Link to="/books/top-rated" className="text-base text-gray-500 hover:text-gray-900">
                      Top Rated
                    </Link>
                  </li>
                  <li>
                    <Link to="/books/new-releases" className="text-base text-gray-500 hover:text-gray-900">
                      New Releases
                    </Link>
                  </li>
                </ul>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  ...
                  <li>
                    <Link to="/profile/reviews" className="text-base text-gray-500 hover:text-gray-900">
                      Your Reviews
                    </Link>
                  </li>
                </ul>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-base text-gray-400 xl:text-center">
            &copy; {currentYear} BookCritic. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
